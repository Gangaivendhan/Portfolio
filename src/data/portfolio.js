...
export const services = [
  {
    ...
    description: 'Building responsive, high-performance web applications using Vue.js, Nuxt.js, HTML5, CSS3 and SCSS.',
  },
  {
    icon: 'Code',
  ...
  },
  {
    ...
    description: 'Pixel-perfect implementation of designs with TypeScript, SCSS, and Bootstrap ensuring cross-browser compatibility.',
  },
  {
    icon: 'Zap',
    title: 'Performance Optimisation',
    description: 'Optimising web app performance — reducing load times, improving responsiveness and enhancing user engagement.',
  },
]
